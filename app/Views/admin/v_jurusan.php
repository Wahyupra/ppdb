                ...
                <tbody>
                    ...
                    foreach ($jurusan as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value['jurusan'] ?></td>
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_jurusan'] ?>"><i class="fas fa-edit"></i></button>
                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_jurusan'] ?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Jurusan</label>
                        <input name="jurusan" value="<?= $value['jurusan'] ?>" class="form-control" placeholder="Jurusan" required>
                    </div>
    ...
    <div class="modal fade" id="delete<?= $value['id_jurusan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus <b><?= $value['jurusan'] ?></b> ?
