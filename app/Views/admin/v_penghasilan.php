        ...
        <tbody>
          ...
          foreach ($penghasilan as $key => $value) { ?>
            <tr>
              ...
              <td>
                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_penghasilan'] ?>"><i class="fas fa-edit"></i></button>
                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_penghasilan'] ?>"><i class="fas fa-trash"></i></button>
              </td>
            </tr>
          <?php } ?>
        </tbody>
